            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense mx-4 mb-4">
                    <button
                      type="submit"
                      className="form-button form-button-primary w-full inline-flex justify-center sm:col-start-2 sm:text-sm"
                      aria-label={
                        editingStaff
                    ...
                    <button
                      type="button"
                      className="form-button form-button-cancel mt-3 w-full inline-flex justify-center sm:mt-0 sm:col-start-1 sm:text-sm"
                      onClick={() => {
                        setIsModalOpen(false);
                        setFormData(initialFormData);
                        setEditingStaff(null);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <button
            ...
            className="form-button form-button-primary inline-flex items-center"
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th
                  scope="col"
                  className="px-6 py-3 text-left text-xs font-medium text-papaya-whip uppercase tracking-wider cursor-pointer hover:text-white transition-colors duration-200"
                  onClick={() => {
