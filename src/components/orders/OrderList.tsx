...
const OrderList: React.FC = () => {
  ...
  const renderSkeletons = () => {
    return Array(4).fill(0).map((_, index) => (
      <div key={`skeleton-${index}`} className="w-full bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 mb-4 animate-pulse">
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading && isInitialLoad ? (
        ...
        <>
          ...
          {loading && !isInitialLoad && sortedOrders.length > 0 && (
            <div className="fixed bottom-4 right-4 bg-white p-2 rounded-full shadow-lg border border-gray-200">
